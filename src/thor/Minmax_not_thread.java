...
public final class Minmax_not_thread implements Callable<List<Integer>>{
    ...
    public Minmax_not_thread(Hashtable<Integer, Hashtable<Integer, StateDictEntry>> state_hash_table, Game game) {
    ...
    public List<Integer> call() throws Exception {
        ...
        for (List<Integer> action : all_actions) {
            ...
            double value = minValue(new BitState(currentState, action), Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, 1, 
   ...
   /* public List<Integer> makeDecision(long max_time, BitState state) throws Exception {
